<%-- 
    Document   : infoTrincheraAmetralladoras
    Created on : 05-jun-2015, 11:42:03
    Author     : Sergio
--%>
...
<div class="row">
    ...
    <div class="col-md-5 col-md-offset-0">
        <div class="row">
            <h1 class="">Trinchera con Ametralladoras</h1>
        </div>
        <div class="row">
        ...
        <div class="panel col-md-9 col-md-offset-1">
            ...
            <div class="col-md-6 col-md-offset-0">
                <a onclick="comprarTropasDefensivas('TRINCHERA_AMETRALLADORAS');">

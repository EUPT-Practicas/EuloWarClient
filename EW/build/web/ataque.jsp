...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function setInfoAtaque(_tipoAtaque) {
...
<!--                <div class="col-md-1 col-md-offset-11 text-right">
            ...
            <div class="panel panel-default col-md-10 col-md-offset-1">
                ...
                <div class="col-md-2 col-md-offset-0">
                    <a href="#" onclick="setInfoAtaque('peloton');">
                    <img src="img/ataque/peloton.png" class="img-responsive" alt="Responsive image">
                    <h5 class="text-center">Peloton () </h5>
                    </a>
                </div>

                <div class="col-md-2 col-md-offset-0">
                    <a href="#" onclick="setInfoAtaque('vehiculoBlindado');">

<%-- 
    Document   : infoHelicoptero
    Created on : 05-jun-2015, 16:13:45
    Author     : Sergio
--%>
...
<div class="col-md-5 col-md-offset-0">
    ...
    <img src="img/ataque/helicoptero.png" class="img-responsive " alt="Responsive image">
</div>
<div class="row">

    <div class="col-md-5 col-md-offset-0">
        <div class="row">
            <h1 class="">Helicóptero Apache</h1>
        </div>
        <div class="row">
        ...
        <div class="panel  col-md-9 col-md-offset-1">
            ...
            <div class="col-md-6 col-md-offset-0">
                <a onclick="comprarTropasOfensivas('HELICOPTERO');">

 ...
 * @author Sergio
 */
public class MejorarAtaque implements Runnable {
    ...
    public MejorarAtaque (String emailUsuario){
        this.emailUsuario = emailUsuario;
        this.ct = new ClienteTropas();
    }
    
    public void mejorarAtaque (){
        ct.mejorarFabricaOfensiva(emailUsuario);
    }

    @Override
    public void run() {
                System.err.println("Mejorando Fabrica Ofensiva: (30 minutos) -- " + emailUsuario);
        try {
